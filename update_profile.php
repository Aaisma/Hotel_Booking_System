...
<div class="container-fluid"style="color:#000;"> <!-- Primary Id-->
  <div class="container">
    <h1 style="background-color:#a1a8a8; border-radius:0px;display:inline-block; text-align: center;"><b><font color="#080808"><br>Update Account?</font></b></h1>
    <div class="row">
      ...
      <div class="col-sm-6 ">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
              ...
              <h4 style="color:#030303; font-size: medium">Current email is required!</h4>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <textarea name="countr" class="form-control"><?php echo $result['country']; ?></textarea>
