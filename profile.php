...
<div class="container-fluid"id="primary"><!--Primary Id-->
  <center><h1 style="background-color:#000000;border-radius:50px;font-family: 'Baloo Bhai', cursive;box-shadow:5px 5px 9px #ffffff;text-shadow:2px 2px#000;display:inline-block;"><br>User Profile</h1></center><br>
  <div class="container">
    <div class="row">
