...
<div class="container-fluid text-center"id="primary"><!--Primary Id-->
    <h1 style="margin-top: 70px;"> BOOKING FORM </h1><br>
    <div class="container">
        <div class="row">
            <?php echo @$msg; ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="radio-inline"><input type="radio" value="More" name="Occupancy" required>More</div>
                            </div>
                        </div>
                    </div>
